...
export const loader = ({ params }: LoaderFunctionArgs) => {
  const project = findProject("threejs", params.slug ?? "");
  if (!project) {
...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
  ...
  return [
    { title: `${title} — ThreeJS Projects` },
    { name: "description", content: data?.project.blurb ?? "" },
  ];
};

export default function ThreeJSProjectDetail() {
  ...
  return (
    <div className="project-detail-container">
      ...
      <main className="project-detail-main">
        <Link to="/threejs" className="project-detail-back">
          &larr; Back to ThreeJS Projects
        </Link>
